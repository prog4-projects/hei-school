package com.hei.school.endpoint.event.consumer;

import com.hei.school.PojaGenerated;
import com.hei.school.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.hei.school.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.hei.school.service.event."
