...
import static com.hei.school.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import com.hei.school.PojaGenerated;
import com.hei.school.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "com.hei.school.event1";
    return "com.hei.school.event2";
  }
}
